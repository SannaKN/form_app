...
// void main() => runApp(const FormValidationDemo());
...
class _FormValidationDemoState extends State<FormValidationDemo> {
  ...
  static const String _title = 'Valintapainike';
...
enum SingingCharacter { color_1, color_2 }
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  SingingCharacter? _character = SingingCharacter.color_1;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ListTile(
          title: const Text('Punainen'),
          leading: Radio<SingingCharacter>(
            value: SingingCharacter.color_1,
        ...
        ListTile(
          title: const Text('Vihreä'),
          leading: Radio<SingingCharacter>(
            value: SingingCharacter.color_2,
            groupValue: _character,
            onChanged: (SingingCharacter? value) {
              setState(() {
                _character = value;
