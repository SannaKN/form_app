...
class _SignInHttpDemoState extends State<SignInHttpDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sisäänkirjautuminen'),
      ),
      body: Form(
        child: Scrollbar(
                ...
                ...[
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      filled: true,
                      hintText: 'Kirjoita sähköpostiosoitteesi',
                  ...
                  FilledButton(
                    child: const Text(
                      'Kirjaudu',
                      semanticsLabel: 'Kirjaudu sisään palveluun',
                    ),
                    onPressed: () async {
                      ...
                      if (result.statusCode == 200) {
                        ...
                        _showDialog('Väärä sähköpostiosoite tai salasana.');
                      } else {
